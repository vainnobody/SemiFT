...
from .moe import SemiFt, SemiFtSAMoE, SemiFtSAMoEV4, SemiFtSAMoEV5, SemiFtSAMoEV6, SemiFtSAMoEV7, SemiFtSAMoEV8, SemiFtScaleGate
...
BLOCK_LEVEL_METHODS = {"semift", "semift_samoe", "samoev4", "samoev5", "samoev6", "samoev7", "samoev8", "semift_scalegate", "adaptformer"}
...
class AdaptModel(nn.Module):
    ...
    def _build_block_level_adapter(self, target_name, target):
        ...
        elif self.peft_config.method == "samoev8":
            adapter = SemiFtSAMoEV8(input_dim, output_dim, **self._semift_kwargs())
    ...
    def _semift_kwargs(self):
        ...
        if self.peft_config.method in {"semift_samoe", "samoev4", "samoev5", "samoev6", "samoev7", "samoev8"}:
            kwargs = {
                "r": self.peft_config.r,
            ...
            if self.peft_config.method in {"samoev5", "samoev6", "samoev7", "samoev8"}:
