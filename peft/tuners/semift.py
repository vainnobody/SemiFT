...
class AdaptModel(nn.Module):
    ...
    def _build_block_level_adapter(self, target_name, target):
        ...
        elif self.peft_config.method == "samoev9":
            adapter = SemiFtSAMoEV9(input_dim, output_dim, **self._semift_kwargs())
    ...
    def _semift_kwargs(self):
        ...
        if self.peft_config.method in {
            ...
            if self.peft_config.method in {"samoev5", "samoev6", "samoev7", "samoev8", "samoev9"}:
