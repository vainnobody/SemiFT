...
def get_parser():
    parser = argparse.ArgumentParser(
        description="WSCL training rebuilt on top of the UniMatch V2-style scaffold"
    )
...
def main(args, cfg):
    ...
    model, load_result = build_model(cfg, method="wscl")
    ...
    for epoch in range(start_epoch, cfg["epochs"]):
        ...
        for i, ((img_x, mask_x), batch_u) in enumerate(zip(trainloader_l, trainloader_u)):
            ...
            entropy_valid = entropy_u[valid_region]
