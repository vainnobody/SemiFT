"""
FixMatch-RGCRv5: UniMatch-style Dual-Strong RGCR
...
def get_parser():
    parser = argparse.ArgumentParser(
        description="FixMatch-RGCRv5: UniMatch-style dual-strong RGCR "
        "for Semi-Supervised Semantic Segmentation"
    )
...
def main(args, cfg):
    ...
    for epoch in range(epoch + 1, cfg["epochs"]):
        ...
        for i, (
            ...
            mask_u_w_cutmixed2 = mask_u_rvs_view.clone()
            conf_u_w_cutmixed2 = conf_u_rvs_view.clone()
            ignore_mask_cutmixed2 = ignore_mask_rvs_view.clone()

            mask_u_w_cutmixed2[cutmix_box2 == 1] = mask_u_rvs_view.flip(0)[
                cutmix_box2 == 1
            ]
            conf_u_w_cutmixed2[cutmix_box2 == 1] = conf_u_rvs_view.flip(0)[
                cutmix_box2 == 1
            ]
